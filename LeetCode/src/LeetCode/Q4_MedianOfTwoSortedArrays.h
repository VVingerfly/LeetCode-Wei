...
#ifndef Q4_MEDIANOFTWOSORTEDARRAYS_H_INCLUDED
#define Q4_MEDIANOFTWOSORTEDARRAYS_H_INCLUDED
...
public:
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2)
    {
		...
		cout<<i1<<"  "<<len1<<endl;
		cout<<i2<<"  "<<len2<<endl;
		for(;i1 < len1; ++i1) numsSort.push_back(nums1.at(i1));
		for(;i2 < len2; ++i2) numsSort.push_back(nums2.at(i2));
...
#endif // Q4_MEDIANOFTWOSORTEDARRAYS_H_INCLUDED
